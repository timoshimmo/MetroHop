    ...
    <div className="flex flex-col h-full bg-primary/5">
      <main className="flex-1 flex flex-col items-center justify-center text-center p-6 space-y-6">
        ...
        <div className="space-y-2">
            <h1 className="text-3xl font-bold font-headline text-primary">Account Created!</h1>
            <p className="text-muted-foreground">You have successfully created your account.</p>
        </div>
      </main>
